"""
Orbit Wars V44 — The Locality Juggernaut (Amplified).

Evolution from V43 (which tested a positive trend vs V39).
Key change: Amplified the additive proximity bonus.
LOCALITY_BONUS_MAX increased from 15 to 25.
LOCALITY_RADIUS tightened from 80 to 50.
This makes the local preference much sharper and stronger.
...
# V44: Amplified Locality bonus — stronger and tighter.
...
LOCALITY_BONUS_MAX = 25.0   # max bonus at distance 0
LOCALITY_RADIUS = 50.0      # bonus tapers to 0 at this distance
