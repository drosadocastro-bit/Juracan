...
class Context:
    ...
    def _build_power_table(self):
        ...
        self.duel_opening = self.is_duel and w.step < 53
    ...
    def _reserve_for(self, planet, nearest_enemy):
        ...
        if self.ffa_behind and incoming <= 0 and nearest_enemy >= 28.1:
            return max(3, planet.production + 1)
    ...
    def _score_targets(self):
        ...
        for t in w.planets:
            ...
            base = t.production * (92.0 if t.owner == -1 else 107.5)
...
def _best_move_for_source(source, surplus, world, ctx, excluded_targets=None):
    ...
    for target in world.planets:
        ...
        if ctx.duel_opening and target.owner == -1:
            score = base - send * 1.14 - distance * 1.30 - eta * 2.00
            ...
            score = base - send * 1.77 - distance * 0.72 - eta * 1.30
            if target.production >= 3:
                score += 18.0
            if target.ships <= 14:
                score += 14.0
            ...
            score = base - send * 1.90 - distance * 0.55 - eta * 1.14
