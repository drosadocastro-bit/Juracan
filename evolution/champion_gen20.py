...
class Context:
    ...
    def _build_power_table(self):
        ...
        self.ffa_opening = (not self.is_duel) and w.step < 48
        self.ffa_behind = (
    ...
    def _reserve_for(self, planet, nearest_enemy):
        ...
        if self.ffa_behind and incoming <= 0 and nearest_enemy >= 31.8:
            return max(3, planet.production + 1)
    ...
    def _score_targets(self):
        ...
        for t in w.planets:
            ...
            base = t.production * (92.0 if t.owner == -1 else 128.6)
...
def _best_move_for_source(source, surplus, world, ctx, excluded_targets=None):
    ...
    for target in world.planets:
        ...
        if ctx.duel_opening and target.owner == -1:
            score = base - send * 1.24 - distance * 1.11 - eta * 1.89
            ...
            score = base - send * 2.29 - distance * 0.54 - eta * 1.12
