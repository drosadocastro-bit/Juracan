"""
Orbit Wars V43 — The Locality Juggernaut.

Evolution from V39 (gold baseline, 729.9 ELO).
Key change: PURELY ADDITIVE proximity bonus in _best_move_for_source.
All of V39's global bonuses are preserved intact — distant targets score
identically to V39, preserving intercontinental reach. Nearby targets
get a small edge on top (+15 at distance 0, tapering to 0 at distance 80).

This avoids V42's subtractive soft-discount approach (which was a wash)
by never reducing any target's score vs V39.
...
# V43: Locality bonus — purely additive nearby preference.
