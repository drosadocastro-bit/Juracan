"""
Orbit Wars V48 — The Iron Sentinel (Frankenstein B).

Evolution from V39 (gold baseline, 729.9 ELO).
Key change: Defense and Efficiency hybrid.
Uses V39's Neutral Trap Abort & Defensive Simulator Engine, combined
with V43's Soft Locality Bonus (+10 for nearby targets) to efficiently
consolidate local borders.
...
def _best_move_for_source(source, surplus, world, ctx, excluded_targets=None):
    ...
    for target in world.planets:
        ...
        # V43 (Limb 3): Locality bonus - purely additive nearby preference.
