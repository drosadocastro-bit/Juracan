...
code = code.replace(
    ...
    "Orbit Wars V18 — Timeline Sniper Engine."
).replace(
    ...
    "V18: Pure V7 baseline with Timeline Sniper Engine. Predicts enemy planet flips and surgically steals them."
)
        ...
        for p in w.planets:
            ...
            for turn in range(1, max_eta + 2):
                ...
                if current_owner not in (-1, w.player) and current_ships <= 5:
                    self.snipe_opportunities.append((p.id, turn + 1, current_owner, current_ships))
"""
...
with open("d:/Juracan/main_v18.py", "w", encoding="utf-8") as f:
    f.write(code)

print("Built main_v18.py")
