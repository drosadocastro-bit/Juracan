"""
Orbit Wars V45 — The Naked Exploit (Vulture Tuning).

Evolution from V39 (gold baseline, 729.9 ELO).
Key change: Refined the Vulture Offense logic to include the "Naked Exploit".
Fixes the "transit expiration" blind spot where the Vulture bonus vanished
the moment an enemy's fleet arrived at its destination. Now, fully exposed
planets receive a massive target bonus whether their ships are still in flight
or have already landed.
